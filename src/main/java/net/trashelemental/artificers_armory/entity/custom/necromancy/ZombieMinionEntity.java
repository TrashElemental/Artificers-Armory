...
public class ZombieMinionEntity extends Zombie implements OwnableMinion {

    @Nullable
    private UUID ownerUUID;
    private boolean hasPlayedEffects = false;

    public ZombieMinionEntity(EntityType<? extends Zombie> type, Level level) {
        super(type, level);
    }
    ...
    public boolean canHoldItem(ItemStack pStack) {
        return pStack.is(ItemTags.SWORDS) || pStack.is(ItemTags.AXES);
    }
