...
public class WitherSkeletonMinionEntity extends WitherSkeleton implements OwnableMinion {

    @Nullable
    private UUID ownerUUID;
    private boolean hasPlayedEffects = false;

    public WitherSkeletonMinionEntity(EntityType<? extends WitherSkeleton> pEntityType, Level pLevel) {
