...
@OnlyIn(Dist.CLIENT)
public class PlagueParticles extends TextureSheetParticle {
    private final float initialQuadSize;

    protected PlagueParticles(ClientLevel world, double x, double y, double z, double xd, double yd, double zd) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel world, double x, double y, double z, double xd, double yd, double zd) {
            PlagueParticles particle = new PlagueParticles(world, x, y, z, xd, yd, zd);
