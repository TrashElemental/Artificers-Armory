...
@OnlyIn(Dist.CLIENT)
public class BlackDeathParticles extends TextureSheetParticle {
    private final float initialQuadSize;

    protected BlackDeathParticles(ClientLevel world, double x, double y, double z, double xd, double yd, double zd) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel world, double x, double y, double z, double xd, double yd, double zd) {
            BlackDeathParticles particle = new BlackDeathParticles(world, x, y, z, xd, yd, zd);
