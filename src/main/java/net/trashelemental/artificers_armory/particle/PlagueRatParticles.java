...
@OnlyIn(Dist.CLIENT)
public class PlagueRatParticles extends TextureSheetParticle {
    private final float initialQuadSize;

    protected PlagueRatParticles(ClientLevel world, double x, double y, double z, double xd, double yd, double zd) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel world, double x, double y, double z, double xd, double yd, double zd) {
            PlagueRatParticles particle = new PlagueRatParticles(world, x, y, z, xd, yd, zd);
