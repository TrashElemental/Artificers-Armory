...
@OnlyIn(Dist.CLIENT)
public class PlagueCloudParticles extends TextureSheetParticle {
    private final float initialQuadSize;

    protected PlagueCloudParticles(ClientLevel world, double x, double y, double z, double xd, double yd, double zd) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel world, double x, double y, double z, double xd, double yd, double zd) {
            PlagueCloudParticles particle = new PlagueCloudParticles(world, x, y, z, xd, yd, zd);
